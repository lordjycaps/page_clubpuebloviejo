...
<div class="content_hero">
    ...
    <div class="content_text_hero">
        <h1 class="hero_title">¿Tienes Dudas?</h1>
        <div class="hero_text">
            <p>
                Vive la experiencia de bienestar que mereces. Relájate y reconéctate.
            </p>
        </div>
    </div>
</div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 aos-init aos-animate" data-aos="fade-up">
            <h2 class="faq-title">¿Tiene alguna pregunta? </h2>
            <p class="faq-description">Consulte las preguntas frecuentes.</p>
